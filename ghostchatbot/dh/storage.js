...
DH.storage = (function () {
    ...
    self.keyExists = function (aKey, aCallback) {
        ...
        if (typeof aKey !== 'string') {
            throw "DH.storage.keyExists key " + aKey + " is not string!";
        }
        try {
    ...
    self.erase = function (aKey) {
        // erase single key
        if (typeof aKey !== 'string') {
            throw "DH.storage.erase key " + aKey + " is not string!";
        }
    ...
    self.eraseAll = function (aNothing) {
        ...
        if (aNothing !== undefined) {
            throw "DH.storage.eraseAll does not require parameter, perhaps you wanted to call DH.storage.erase(key)";
        }
        localStorage.clear();
    };
    ...
    self.readString = function (aKey, aDefault, aCallback) {
        ...
        var r;
        if (typeof aKey !== 'string') {
            throw "DH.storage.readString key " + aKey + " is not string!";
        }
        if ((aDefault !== undefined) && (typeof aDefault !== 'string')) {
            throw "DH.storage.readString default " + aDefault + " is not string nor undefined!";
        }
        self.ops++;
        try {
            if (localStorage.hasOwnProperty(aKey)) {
            ...
            console.warn('DH.storage.writeString: ' + e);
        }
        cb(aCallback, r);
        return r;
    };
    ...
    self.writeString = function (aKey, aValue, aCallback) {
        // write string
        if (typeof aKey !== 'string') {
            throw "DH.storage.writeString key " + aKey + " is not string!";
        }
        if ((aValue !== undefined) && (typeof aValue !== 'string')) {
            throw "DH.storage.writeString value " + aValue + " is not string nor undefined!";
        }
        self.ops++;
        try {
    ...
    self.readBoolean = function (aKey, aDefault, aCallback) {
        ...
        if ((s !== 'true') && (s !== 'false')) {
            console.warn('DH.storage.readBoolean: unusual boolean value "' + s + '" for "' + aKey + '", using default');
            cb(aCallback, aDefault || false);
            return aDefault || false;
        }
        cb(aCallback, s === 'true');
    ...
    self.writeBoolean = function (aKey, aValue, aCallback) {
        ...
        if ((aValue !== true) && (aValue !== false)) {
            console.warn('DH.storage.writeBoolean: unusual boolean value "' + aValue + '" for "' + aKey + '", using false');
        }
    ...
    self.readNumber = function (aKey, aDefault, aCallback) {
        ...
        f = parseFloat(s);
        if (isNaN(f)) {
            console.warn('DH.storage.readNumber: unusual number value "' + s + '" for "' + aKey + '", using default');
            cb(aCallback, aDefault || 0);
            return aDefault || 0;
        }
        cb(aCallback, f);
    ...
    self.writeNumber = function (aKey, aValue, aCallback) {
        ...
        if (typeof aValue !== 'number') {
            console.warn('DH.storage.writeNumber: unusual number value "' + aValue + '" for "' + aKey + '", using 0');
    ...
    self.readObject = function (aKey, aDefault, aCallback) {
        ...
        if (typeof aDefault !== 'object') {
            console.warn('DH.storage.readObject: default is not object in "' + aKey + '" but "' + aDefault + '", using {}');
            aDefault = {};
        }
        if (s === undefined) {
        ...
        o = JSON.parse(s);
        if (typeof o !== 'object') {
            console.warn('DH.storage.readObject: unusual value "' + s + '" for "' + aKey + '", using default');
            cb(aCallback, aDefault);
            return aDefault;
        }
        cb(aCallback, o);
    ...
    self.writeObject = function (aKey, aValue, aCallback) {
        ...
        if (typeof aValue !== 'object') {
            console.warn('DH.storage.writeObject: unusual object value "' + aValue + '" for "' + aKey + '", using {}');
    ...
    self.readArray = function (aKey, aDefault, aCallback) {
        ...
        if (!Array.isArray(aDefault)) {
            console.warn('DH.storage.readArray: default is not array in "' + aKey + '" but "' + aDefault + '", using []');
            aDefault = [];
        }
        if (s === undefined) {
            cb(aCallback, aDefault);
        ...
        o = JSON.parse(s);
        if (!Array.isArray(o)) {
            console.warn('DH.storage.readArray: unusual value "' + s + '" for "' + aKey + '", using default');
            cb(aCallback, aDefault);
            return aDefault;
        }
        cb(aCallback, o);
    ...
    self.writeArray = function (aKey, aValue, aCallback) {
        ...
        if (!Array.isArray(aValue)) {
            console.warn('DH.storage.writeArray: unusual array value "' + aValue + '" for "' + aKey + '", using []');
            self.writeString(aKey, '[]');
            cb(aCallback, []);
        } else {
            self.writeString(aKey, JSON.stringify(aValue));
